...
the DELTA model. You can take a look at ****Figure 2***** for a quick
...
results matter. For example, *Figure 4** shows a part of the explanation
the author gives to illustrate his point.
